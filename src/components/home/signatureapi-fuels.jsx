...
// /:https://framerusercontent.com/modules/dfEHdyQGzDOtRc9xQiqb/HBxOwZv6YLCVw6EEg5z3/NoP5dhqtt.js
...
var cycleOrder = ["U428bx6uR", "dFm5YmL70", "Pl4oqzqm3"];
var serializationHash = "framer-IeMy9";
var variantClassNames = {
	dFm5YmL70: "framer-v-14pkqre",
	Pl4oqzqm3: "framer-v-1dcenr1",
	U428bx6uR: "framer-v-1md3cdn",
};
...
var getProps2 = ({ height, id, width, ...props }) => {
	return {
		...props,
		variant:
			humanReadableVariantMap[props.variant] ?? props.variant ?? "U428bx6uR",
	};
};
					...
					>
						...
						>
								...
								background={{
									...
									loading: getLoadingLazyAtYPosition(
										(componentViewport?.y || 0) +
											0 +
											(((componentViewport?.height || 200) - 0 - 837) / 2 +
												0 +
												0) +
											120 +
											0,
									...
									pixelHeight: 92,
									pixelWidth: 119,
									src: "https://framerusercontent.com/images/SsqAWfqzVWL0dhjJQ5ciWxpdYpg.png?width=119&height=92",
								}}
								className={"framer-q6vasc"}
										...
										dFm5YmL70: {
											background: {
												...
												loading: getLoadingLazyAtYPosition(
													(componentViewport?.y || 0) +
														0 +
														(((componentViewport?.height || 200) - 0 - 1252) /
															2 +
															0 +
															0) +
														80 +
										...
										Pl4oqzqm3: {
											background: {
												...
												loading: getLoadingLazyAtYPosition(
													(componentViewport?.y || 0) +
														0 +
														(((componentViewport?.height || 200) - 0 - 1096) /
															2 +
															0 +
															0) +
														64 +
							...
							<RichText
								...
								className={"framer-yyd1yg"}
								data-framer-name={"Electronic Signatures\xA0for your AI Agents"}
								fonts={["Inter"]}
								layoutDependency={layoutDependency}
								layoutId={"Bj7UYYtvM"}
								style={{
							...
							>
								<React2.Fragment>
									...
									>
										{"Signature API fuels modern companies"}
									</motion2.h2>
								</React2.Fragment>
							</RichText>
						</motion2.div>
						<motion2.div
							className={"framer-ine1rv"}
							data-border={true}
						...
						>
							<motion2.div
								className={"framer-1l119f0"}
								data-framer-name={"start-empty"}
								layoutDependency={layoutDependency}
								layoutId={"XIRckDwi3"}
							>
								<motion2.div
									className={"framer-67sw7s"}
									data-framer-name={"l"}
									layoutDependency={layoutDependency}
									layoutId={"XswxW8yXX"}
								/>
								<motion2.div
									className={"framer-16jwznt"}
									data-border={true}
									data-framer-name={"c"}
									layoutDependency={layoutDependency}
									layoutId={"BsZYJOcs2"}
							...
							<motion2.div
								className={"framer-s6704h"}
								data-framer-name={"start-empty"}
								layoutDependency={layoutDependency}
								layoutId={"GAJFtXBRe"}
							>
								<motion2.div
									className={"framer-13duxud"}
									data-border={true}
									data-framer-name={"l"}
									layoutDependency={layoutDependency}
									layoutId={"c9tsDadZE"}
								...
								>
									{_jsx2(stdin_default, {
										animated: true,
										className: "framer-1kel9vl",
										layoutDependency,
										layoutId: "hI_12h8P1",
									})}
								</motion2.div>
								<motion2.div
									className={"framer-k1q537"}
									data-border={true}
									data-framer-name={"c"}
									layoutDependency={layoutDependency}
									layoutId={"ulJGok2eW"}
								...
								>
									<motion2.div
										className={"framer-19qsfa7"}
										data-border={true}
										data-framer-name={"quote-block"}
										layoutDependency={layoutDependency}
										layoutId={"I7ZNTCyQj"}
										style={{
											"--border-bottom-width": "0px",
									...
									>
										<RichText
											...
											style={{
												...
												"--extracted-1r4zm10": '"opsz" 14, "wght" 450',
												"--extracted-1wi65aa":
														...
														children: (
															<React2.Fragment>
																<motion2.h4
																	style={{
																		"--font-selector":
																			"SW50ZXItVmFyaWFibGVWRj1JbTl3YzNvaUlERTBMQ0FpZDJkb2RDSWdORFV3",
																		"--framer-font-family":
																			'"Inter Variable", "Inter Placeholder", sans-serif',
																		"--framer-font-variation-axes":
																			'var(--extracted-1r4zm10, "opsz" 14, "wght" 450)',
																		"--framer-line-height": "20px",
																		"--framer-text-color":
																			"var(--extracted-1eung3n, var(--token-d6940146-3092-44f2-b461-b1ae29af8487, rgb(104, 104, 112)))",
																	}}
																>
																	{
																	...
																	<motion2.span
																		style={{
																			"--framer-text-color":
																				"var(--extracted-1wi65aa, var(--token-21c8ed69-0c54-4c11-bfd2-6cc87f53f87a, rgb(24, 24, 27)))",
																		}}
																	>
																		{
																			'It\u2019s been a great tool for both small features and larger workflows."'
																		}
																	</motion2.span>
																</motion2.h4>
															</React2.Fragment>
										...
										>
											<Image
												background={{
													...
													loading: getLoadingLazyAtYPosition(
														(componentViewport?.y || 0) +
															0 +
															(((componentViewport?.height || 200) - 0 - 837) /
																2 +
																296 +
																0) +
															0 +
													...
													pixelHeight: 232,
													pixelWidth: 232,
													src: "https://framerusercontent.com/images/Mh4gdPGprkuGbeKpvd2wMoSCqM.png?width=232&height=232",
												}}
												className={"framer-gtb38d"}
											...
											/>
											<motion2.div
												className={"framer-1uwzzmx"}
												layoutDependency={layoutDependency}
												layoutId={"vgjdc3Tu9"}
											>
												<motion2.div
													className={"framer-uk7rwt"}
													layoutDependency={layoutDependency}
													layoutId={"PuU9mSrl8"}
												>
													<RichText
														__fromCanvasComponent={true}
														className={"framer-qfaalx"}
														data-framer-name={
													...
													Pl4oqzqm3: {
														children: (
															<React2.Fragment>
																...
																>
																	{
																		"\u201CLien waivers used to be the choke\u2011point in our disbursement process\u2014we were always chasing signatures and re\u2011entering data. "
																	}
																	<motion2.span
																		style={{
																			"--framer-text-color":
																	...
																	>
																		{
																			"SignatureAPI dropped straight into our stack and now waivers go out, get signed, and come back automatically in minutes."
																		}
																	</motion2.span>
																	{
																		" It\u2019s shaved hours off every draw and keeps our projects moving.\u201D"
																	}
																</motion2.h4>
															</React2.Fragment>
														),
										...
										>
											<Image
												background={{
													...
													pixelHeight: 252,
													pixelWidth: 252,
													src: "https://framerusercontent.com/images/dYWiwwc7h0CC43GG4nXi16zM.png?width=252&height=252",
												}}
												className={"framer-ulj6bt"}
												data-framer-name={"Image"}
												layoutDependency={layoutDependency}
												layoutId={"D70A51CMI"}
												style={{
											...
											/>
											<motion2.div
												className={"framer-1av0i2j"}
												layoutDependency={layoutDependency}
												layoutId={"YhJGVGsrK"}
											>
												<motion2.div
													className={"framer-1ygq2pw"}
													layoutDependency={layoutDependency}
													layoutId={"uG3OxVSwy"}
												>
													<RichText
														__fromCanvasComponent={true}
														className={"framer-oiouuw"}
														data-framer-name={
															"The Electronic Signatures in Global and National Commerce (ESIGN) Act, passed in 2000, legally recognizes electronic signatures and records in US commerce."
														}
														fonts={["Inter-Medium"]}
													...
													Pl4oqzqm3: {
														children: (
															<React2.Fragment>
																...
																>
																	{
																		"\u201CSignatureAPI took the hassle out of sending insurance claims for signature. "
																	}
																	<motion2.span
																		style={{
																			"--framer-text-color":
																	...
																	>
																		{
																			"It\u2019s fast, simple, and backed by solid support. It just works.\u201D"
																		}
																	</motion2.span>
																</motion2.h4>
															</React2.Fragment>
										...
										>
											<Image
												background={{
													...
													pixelHeight: 207,
													pixelWidth: 207,
													src: "https://framerusercontent.com/images/ngbKcblKdV1qPpEBXJph1ltBU4.png?width=207&height=207",
												}}
												className={"framer-1evq7rg"}
												data-framer-name={"Image"}
												layoutDependency={layoutDependency}
												layoutId={"V3NN41gAC"}
												style={{
											...
											/>
											<motion2.div
												className={"framer-k03zdl"}
												layoutDependency={layoutDependency}
												layoutId={"LlImcQpNa"}
											>
												<motion2.div
													className={"framer-19w3vcu"}
													layoutDependency={layoutDependency}
													layoutId={"HtewZSKYF"}
												>
													<RichText
														__fromCanvasComponent={true}
														className={"framer-1mm8r8e"}
														data-framer-name={
															"The Electronic Signatures in Global and National Commerce (ESIGN) Act, passed in 2000, legally recognizes electronic signatures and records in US commerce."
														}
														fonts={["Inter-Medium"]}
							...
							<motion2.div
								className={"framer-1son7wi"}
								data-framer-name={"end-empty"}
								layoutDependency={layoutDependency}
								layoutId={"elbWC_qHO"}
							>
								<motion2.div
									className={"framer-5gq6x5"}
									data-framer-name={"l"}
									layoutDependency={layoutDependency}
									layoutId={"SGqhkxS9C"}
								/>
								<motion2.div
									className={"framer-z9z3is"}
									data-border={true}
									data-framer-name={"c"}
									layoutDependency={layoutDependency}
									layoutId={"d2GNcttJh"}
							...
							<motion2.div
								className={"framer-13ry5ii"}
								data-framer-name={"tl"}
								layoutDependency={layoutDependency}
								layoutId={"Qd1bReNir"}
							>
								<motion2.div
									className={"framer-14r0tog"}
							...
							<motion2.div
								className={"framer-bihy8d"}
								data-framer-name={"br"}
								layoutDependency={layoutDependency}
								layoutId={"YGhbEhMfm"}
							>
								<motion2.div
									className={"framer-1wcc7cq"}
									data-framer-name={"Rectangle 3"}
									layoutDependency={layoutDependency}
									layoutId={"itwq6mMkR"}
									style={{
...
var css4 = [
	...
	".framer-IeMy9.framer-g1mxze, .framer-IeMy9 .framer-g1mxze { display: block; }",
	".framer-IeMy9.framer-1md3cdn { align-content: center; align-items: center; display: flex; flex-direction: column; flex-wrap: nowrap; gap: 0px; height: min-content; justify-content: center; overflow: visible; padding: 0px 40px 0px 40px; position: relative; width: 1200px; }",
	".framer-IeMy9 .framer-1vpjf22 { align-content: center; align-items: center; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 32px; height: min-content; justify-content: center; max-width: 1360px; overflow: visible; padding: 120px 120px 48px 120px; position: relative; width: 100%; }",
	".framer-IeMy9 .framer-q6vasc { aspect-ratio: 1.2934782608695652 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 48px); overflow: visible; position: relative; width: 62px; }",
	".framer-IeMy9 .framer-yyd1yg, .framer-IeMy9 .framer-qfaalx, .framer-IeMy9 .framer-g1sohp, .framer-IeMy9 .framer-mc48c, .framer-IeMy9 .framer-oiouuw, .framer-IeMy9 .framer-15x6mwi, .framer-IeMy9 .framer-1x4u9j9, .framer-IeMy9 .framer-1mm8r8e, .framer-IeMy9 .framer-1b670sj, .framer-IeMy9 .framer-j1ghdk { flex: none; height: auto; position: relative; white-space: pre; width: auto; }",
	".framer-IeMy9 .framer-ine1rv { align-content: flex-start; align-items: flex-start; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 0px; height: min-content; justify-content: center; max-width: 1360px; overflow: hidden; padding: 0px; position: relative; width: 100%; }",
	".framer-IeMy9 .framer-1l119f0 { align-content: flex-start; align-items: flex-start; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 0px; height: 24px; justify-content: flex-start; overflow: visible; padding: 0px; position: relative; width: 100%; }",
	".framer-IeMy9 .framer-67sw7s, .framer-IeMy9 .framer-455abz, .framer-IeMy9 .framer-5gq6x5, .framer-IeMy9 .framer-kjn381 { align-content: flex-start; align-items: flex-start; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 10px; height: 100%; justify-content: flex-start; min-width: 120px; overflow: hidden; padding: 10px; position: relative; width: min-content; }",
	".framer-IeMy9 .framer-16jwznt, .framer-IeMy9 .framer-z9z3is { align-content: flex-start; align-items: flex-start; display: flex; flex: 1 0 0px; flex-direction: column; flex-wrap: nowrap; gap: 10px; height: 100%; justify-content: flex-start; overflow: hidden; padding: 10px; position: relative; width: 1px; }",
	".framer-IeMy9 .framer-s6704h { align-content: flex-start; align-items: flex-start; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 0px; height: min-content; justify-content: flex-start; overflow: visible; padding: 0px; position: relative; width: 100%; }",
	".framer-IeMy9 .framer-13duxud, .framer-IeMy9 .framer-u18vxb { align-content: flex-start; align-items: flex-start; align-self: stretch; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 10px; height: auto; justify-content: flex-start; overflow: hidden; padding: 10px; position: relative; width: 120px; }",
	".framer-IeMy9 .framer-1kel9vl, .framer-IeMy9 .framer-1mku75b { flex: none; height: var(--framer-aspect-ratio-supported, 815px); left: 0px; position: absolute; top: 0px; width: 1320px; z-index: 1; }",
	".framer-IeMy9 .framer-k1q537 { align-content: flex-start; align-items: flex-start; display: flex; flex: 1 0 0px; flex-direction: row; flex-wrap: nowrap; gap: 0px; height: min-content; justify-content: flex-start; overflow: hidden; padding: 0px; position: relative; width: 1px; }",
	".framer-IeMy9 .framer-19qsfa7, .framer-IeMy9 .framer-1c45wd7 { align-content: flex-start; align-items: flex-start; align-self: stretch; display: flex; flex: 1 0 0px; flex-direction: column; flex-wrap: nowrap; gap: 40px; height: auto; justify-content: flex-start; overflow: hidden; padding: 40px; position: relative; width: 1px; }",
	".framer-IeMy9 .framer-zyo51e, .framer-IeMy9 .framer-8v5eot { flex: 1 0 0px; height: 1px; position: relative; white-space: pre-wrap; width: 100%; word-break: break-word; word-wrap: break-word; }",
	".framer-IeMy9 .framer-1ixnl2j, .framer-IeMy9 .framer-1h1adfu, .framer-IeMy9 .framer-1hnkfn { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 12px; height: min-content; justify-content: center; overflow: hidden; padding: 0px; position: relative; width: 100%; }",
	".framer-IeMy9 .framer-gtb38d, .framer-IeMy9 .framer-ulj6bt, .framer-IeMy9 .framer-1evq7rg { aspect-ratio: 1 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 40px); overflow: visible; position: relative; width: 40px; }",
	".framer-IeMy9 .framer-1uwzzmx, .framer-IeMy9 .framer-1av0i2j, .framer-IeMy9 .framer-k03zdl { align-content: flex-start; align-items: flex-start; display: flex; flex: 1 0 0px; flex-direction: column; flex-wrap: nowrap; gap: 0px; height: min-content; justify-content: center; overflow: hidden; padding: 0px; position: relative; width: 1px; }",
	".framer-IeMy9 .framer-uk7rwt, .framer-IeMy9 .framer-1ygq2pw, .framer-IeMy9 .framer-19w3vcu { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: min-content; justify-content: flex-start; overflow: hidden; padding: 0px; position: relative; width: 100%; }",
	".framer-IeMy9 .framer-1vvuj5a { align-content: flex-start; align-items: flex-start; display: flex; flex: 1 0 0px; flex-direction: column; flex-wrap: nowrap; gap: 40px; height: min-content; justify-content: flex-start; overflow: hidden; padding: 40px; position: relative; width: 1px; }",
	".framer-IeMy9 .framer-tvb3c8 { flex: none; height: auto; position: relative; white-space: pre-wrap; width: 100%; word-break: break-word; word-wrap: break-word; }",
	".framer-IeMy9 .framer-1son7wi { align-content: flex-start; align-items: flex-start; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 0px; height: 120px; justify-content: flex-start; overflow: visible; padding: 0px; position: relative; width: 100%; }",
	".framer-IeMy9 .framer-13ry5ii { flex: none; height: 15px; left: 113px; overflow: visible; position: absolute; top: 17px; width: 15px; z-index: 1; }",
	".framer-IeMy9 .framer-14r0tog, .framer-IeMy9 .framer-4xalwu, .framer-IeMy9 .framer-1wcc7cq, .framer-IeMy9 .framer-1khkb2k { flex: none; height: 15px; left: 7px; position: absolute; top: 0px; width: 1px; }",
	".framer-IeMy9 .framer-bihy8d { bottom: 113px; flex: none; height: 15px; overflow: visible; position: absolute; right: 113px; width: 15px; z-index: 1; }",
	".framer-IeMy9.framer-v-14pkqre.framer-1md3cdn { padding: 0px 20px 0px 20px; width: 800px; }",
	".framer-IeMy9.framer-v-14pkqre .framer-1vpjf22 { padding: 80px 120px 48px 120px; }",
	".framer-IeMy9.framer-v-14pkqre .framer-q6vasc { height: var(--framer-aspect-ratio-supported, 40px); width: 52px; }",
	".framer-IeMy9.framer-v-14pkqre .framer-67sw7s, .framer-IeMy9.framer-v-14pkqre .framer-455abz, .framer-IeMy9.framer-v-14pkqre .framer-5gq6x5, .framer-IeMy9.framer-v-14pkqre .framer-kjn381 { min-width: unset; width: 40px; }",
	".framer-IeMy9.framer-v-14pkqre .framer-13duxud, .framer-IeMy9.framer-v-14pkqre .framer-u18vxb { width: 40px; }",
	".framer-IeMy9.framer-v-14pkqre .framer-1kel9vl, .framer-IeMy9.framer-v-14pkqre .framer-1mku75b, .framer-IeMy9.framer-v-1dcenr1 .framer-1kel9vl, .framer-IeMy9.framer-v-1dcenr1 .framer-1mku75b { height: var(--framer-aspect-ratio-supported, 776px); }",
	".framer-IeMy9.framer-v-14pkqre .framer-k1q537, .framer-IeMy9.framer-v-1dcenr1 .framer-k1q537 { flex-direction: column; }",
	".framer-IeMy9.framer-v-14pkqre .framer-19qsfa7, .framer-IeMy9.framer-v-14pkqre .framer-1c45wd7 { align-self: unset; flex: none; gap: 32px; height: min-content; padding: 32px; width: 100%; }",
	".framer-IeMy9.framer-v-14pkqre .framer-zyo51e, .framer-IeMy9.framer-v-14pkqre .framer-8v5eot, .framer-IeMy9.framer-v-1dcenr1 .framer-zyo51e, .framer-IeMy9.framer-v-1dcenr1 .framer-8v5eot { flex: none; height: auto; }",
	".framer-IeMy9.framer-v-14pkqre .framer-1vvuj5a { flex: none; gap: 32px; padding: 32px; width: 100%; }",
	".framer-IeMy9.framer-v-14pkqre .framer-ulj6bt, .framer-IeMy9.framer-v-1dcenr1 .framer-ulj6bt { height: var(--framer-aspect-ratio-supported, 253px); }",
	".framer-IeMy9.framer-v-14pkqre .framer-1evq7rg, .framer-IeMy9.framer-v-1dcenr1 .framer-1evq7rg { height: var(--framer-aspect-ratio-supported, 207px); }",
	".framer-IeMy9.framer-v-14pkqre .framer-13ry5ii { left: 33px; }",
	".framer-IeMy9.framer-v-14pkqre .framer-bihy8d { right: 33px; }",
	".framer-IeMy9.framer-v-1dcenr1.framer-1md3cdn { padding: 0px 4px 0px 4px; width: 390px; }",
	".framer-IeMy9.framer-v-1dcenr1 .framer-1vpjf22 { padding: 64px 24px 32px 24px; }",
	".framer-IeMy9.framer-v-1dcenr1 .framer-q6vasc { height: var(--framer-aspect-ratio-supported, 32px); width: 41px; }",
	".framer-IeMy9.framer-v-1dcenr1 .framer-yyd1yg { white-space: pre-wrap; width: 100%; word-break: break-word; word-wrap: break-word; }",
	".framer-IeMy9.framer-v-1dcenr1 .framer-67sw7s, .framer-IeMy9.framer-v-1dcenr1 .framer-455abz, .framer-IeMy9.framer-v-1dcenr1 .framer-5gq6x5, .framer-IeMy9.framer-v-1dcenr1 .framer-kjn381 { min-width: unset; padding: 0px; width: 16px; }",
	".framer-IeMy9.framer-v-1dcenr1 .framer-13duxud, .framer-IeMy9.framer-v-1dcenr1 .framer-u18vxb { padding: 0px; width: 16px; }",
	".framer-IeMy9.framer-v-1dcenr1 .framer-19qsfa7, .framer-IeMy9.framer-v-1dcenr1 .framer-1c45wd7 { align-self: unset; flex: none; gap: 32px; height: min-content; padding: 24px; width: 100%; }",
	".framer-IeMy9.framer-v-1dcenr1 .framer-1vvuj5a { flex: none; gap: 32px; padding: 24px; width: 100%; }",
	".framer-IeMy9.framer-v-1dcenr1 .framer-1son7wi { height: 64px; }",
	".framer-IeMy9.framer-v-1dcenr1 .framer-13ry5ii { left: 9px; }",
	".framer-IeMy9.framer-v-1dcenr1 .framer-bihy8d { bottom: 57px; right: 9px; }",
	...css2,
	...css,
	'.framer-IeMy9[data-border="true"]::after, .framer-IeMy9 [data-border="true"]::after { content: ""; border-width: var(--border-top-width, 0) var(--border-right-width, 0) var(--border-bottom-width, 0) var(--border-left-width, 0); border-color: var(--border-color, none); border-style: var(--border-style, none); width: 100%; height: 100%; position: absolute; box-sizing: border-box; left: 0; top: 0; border-radius: inherit; pointer-events: none; }',
];
var FramerNoP5dhqtt = withCSS2(Component2, css4, "framer-IeMy9");
var stdin_default2 = FramerNoP5dhqtt;
FramerNoP5dhqtt.displayName = "signatureapi-fuels";
FramerNoP5dhqtt.defaultProps = {
	height: 912,
	width: 1200,
};
addPropertyControls(FramerNoP5dhqtt, {
	variant: {
		options: ["U428bx6uR", "dFm5YmL70", "Pl4oqzqm3"],
...
/**
 * Renders SignatureapiFuelsFramerComponent for all breakpoints with a variants map. Variant prop is inferred per breakpoint.
 * @function
...
var signatureapi_fuels_default = ComponentWithRoot;
export { signatureapi_fuels_default as default };
