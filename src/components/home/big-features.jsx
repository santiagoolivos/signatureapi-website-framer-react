...
// /:https://framerusercontent.com/modules/6i4DjGhOKcm6W1sywpqX/ICcVrnaV5Kfz5H3ZwYtW/YVrYEME2g.js
...
var Component = /* @__PURE__ */ React.forwardRef(function (props, ref) {
	...
	return (
		<SVG
			{...restProps}
			alt={""}
			className={cx("framer-QYSrD", className6)}
			layoutId={layoutId}
			ref={ref}
			src={
...
var Icon = withCSS(Component, css4, "framer-QYSrD");
				...
				<Transition value={transition1}>
					...
					>
						<motion2.a
							{...restProps}
							{...gestureHandlers}
							className={`${cx2(scopingClassNames, "framer-a22vbk", className6, classNames)} framer-15z7jyz`}
							data-border={true}
							data-framer-name={"sm"}
...
var FramerPg495ozIB = withCSS2(Component2, css6, "framer-guU1i");
...
fontStore5.loadFonts(["GF;Geist Mono-500", "GF;Geist Mono-700"]);
var fonts5 = [
	{
		explicitInter: true,
		fonts: [
...
var FramerqXRWmdo7f = withCSS3(Component3, css8, "framer-2MFhQ");
...
var cycleOrder2 = ["tndu84moK", "hgCHNxY4q", "c8zs43rnL"];
var serializationHash3 = "framer-VnsGL";
var variantClassNames3 = {
	c8zs43rnL: "framer-v-lggb7y",
	hgCHNxY4q: "framer-v-e3ermz",
	tndu84moK: "framer-v-wca900",
};
...
var getProps4 = ({ height, id, width, ...props }) => {
	return {
		...props,
		variant:
			humanReadableVariantMap2[props.variant] ?? props.variant ?? "tndu84moK",
	};
};
...
var Component4 = /* @__PURE__ */ React4.forwardRef(function (props, ref) {
	...
	const isDisplayed = () => {
		if (baseVariant === "c8zs43rnL") return true;
		return false;
	};
	return (
				...
				<Transition3 value={transition13}>
					...
					>
						...
						>
							<RichText3
								__fromCanvasComponent={true}
								className={"framer-1jstzz6"}
								data-framer-name={
									"SignatureAPI handles the full signing workflow. Generate documents from templates, send them for signatures, and retrieve a compliant signed document."
								}
								fonts={["Inter"]}
								layoutDependency={layoutDependency}
								layoutId={"e6VbBXuzc"}
										...
										c8zs43rnL: {
											children: (
												<React4.Fragment>
													...
													>
														{"SignatureAPI handles the full signing workflow. "}
														<motion4.span
															style={{
																"--framer-text-color":
																	"var(--extracted-1k2zljd, var(--token-04709e6b-ac96-47de-b348-7e8009cc46aa, rgb(161, 161, 170)))",
															}}
														>
															{
																"Generate documents from templates, send them for signatures, and retrieve"
															}
														</motion4.span>
														{" a compliant signed document."}
													</motion4.h3>
												</React4.Fragment>
											),
										},
						...
						>
							<motion4.div
								className={"framer-1hnq8ol"}
								data-framer-name={"start-empty"}
								layoutDependency={layoutDependency}
								layoutId={"WjaeqAhk3"}
							>
								<motion4.div
									className={"framer-8u1j9i"}
									data-framer-name={"l"}
									layoutDependency={layoutDependency}
									layoutId={"Z0_KNfHkD"}
								/>
								<motion4.div
									className={"framer-vgdj4l"}
									data-border={true}
									data-framer-name={"c"}
									layoutDependency={layoutDependency}
									layoutId={"Ylq5GeR4M"}
							...
							{isDisplayed() && (
								<motion4.div
									className={"framer-16pktni"}
									data-framer-name={"start-empty"}
									layoutDependency={layoutDependency}
									layoutId={"snS97U3hP"}
								>
									<motion4.div
										className={"framer-1onlhd5"}
										data-framer-name={"l"}
										layoutDependency={layoutDependency}
										layoutId={"rluK5WLB0"}
									/>
									<motion4.div
										className={"framer-qctbqw"}
										data-border={true}
										data-framer-name={"c"}
										layoutDependency={layoutDependency}
										layoutId={"SPAsvK4_z"}
							...
							<motion4.div
								className={"framer-69zysk"}
								data-framer-name={"templates"}
								layoutDependency={layoutDependency}
								layoutId={"zFsHZ6Qaw"}
							>
								<motion4.div
									className={"framer-1o0b4lv"}
									data-border={true}
									data-framer-name={"l"}
									layoutDependency={layoutDependency}
									layoutId={"TK93cLcRS"}
								...
								>
									{_jsx4(stdin_default, {
										animated: true,
										className: "framer-8q8lf5",
										layoutDependency,
										layoutId: "l5__1gFhT",
									})}
								</motion4.div>
								<motion4.div
									className={"framer-1bnygjp"}
									data-border={true}
									data-framer-name={"c"}
									layoutDependency={layoutDependency}
									layoutId={"QDqOD9yUT"}
								...
								>
									...
									>
										<ComponentViewportProvider
											...
											y={
												...
												0 +
												(((componentViewport?.height || 200) - 0 - 1440) / 2 +
													272 +
													0) +
												0 +
												24 +
											...
											{...addPropertyOverrides2(
												{
													c8zs43rnL: {
														y:
															(componentViewport?.y || 0) +
															0 +
															(((componentViewport?.height || 200) - 0 - 1424) /
																2 +
																120 +
																0) +
															0 +
										...
										>
											<SmartComponentScopedContainer
												className={"framer-1936ak5-container"}
												layoutDependency={layoutDependency}
												layoutId={"gdRbFPH8g-container"}
												nodeId={"gdRbFPH8g"}
											...
											>
												{_jsx4(stdin_default3, {
													...
													kWLkauSoU: "\uF5FD",
													layoutId: "gdRbFPH8g",
													QpJ3dK1Uw: "out of shelf",
													width: "100%",
												})}
											</SmartComponentScopedContainer>
										</ComponentViewportProvider>
										<motion4.div
											className={"framer-l8s9l5"}
											data-framer-name={"text"}
											layoutDependency={layoutDependency}
											layoutId={"xMPRZhCm4"}
										>
											...
											<RichText3
												__fromCanvasComponent={true}
												className={"framer-ctkrvo"}
												data-framer-name={
													"Start with a .docx file, add placeholders, and populate it with dynamic data to generate documents ready for signing."
												}
												fonts={["Inter"]}
												layoutDependency={layoutDependency}
												layoutId={"YYgBWMF7I"}
										...
										>
											<SmartComponentScopedContainer
												className={"framer-og9rnu-container"}
												layoutDependency={layoutDependency}
												layoutId={"xXUsaKVvE-container"}
												nodeId={"xXUsaKVvE"}
												rendersWithMotion={true}
												scopeId={"YVrYEME2g"}
											>
									...
									<Image
										background={{
											...
											positionX: "left",
											positionY: "top",
											sizes: `max(max(min(${componentViewport?.width || "100vw"} - 80px, 1360px) - 240px, 1px) / 1.5, 1px)`,
											src: "https://framerusercontent.com/images/8IMAFAt4WiCjsBlANgyIeXMlaY.png?width=1440&height=1126",
											srcSet:
												"https://framerusercontent.com/images/8IMAFAt4WiCjsBlANgyIeXMlaY.png?scale-down-to=512&width=1440&height=1126 512w,https://framerusercontent.com/images/8IMAFAt4WiCjsBlANgyIeXMlaY.png?scale-down-to=1024&width=1440&height=1126 1024w,https://framerusercontent.com/images/8IMAFAt4WiCjsBlANgyIeXMlaY.png?width=1440&height=1126 1440w",
										}}
										className={"framer-1wbzjoo"}
										...
										{...addPropertyOverrides2(
											{
												...
												hgCHNxY4q: {
													background: {
														...
														positionX: "left",
														positionY: "top",
														sizes: `max(max(min(${componentViewport?.width || "100vw"} - 40px, 1360px) - 80px, 1px) * 0.56, 1px)`,
														src: "https://framerusercontent.com/images/8IMAFAt4WiCjsBlANgyIeXMlaY.png?width=1440&height=1126",
														srcSet:
															"https://framerusercontent.com/images/8IMAFAt4WiCjsBlANgyIeXMlaY.png?scale-down-to=512&width=1440&height=1126 512w,https://framerusercontent.com/images/8IMAFAt4WiCjsBlANgyIeXMlaY.png?scale-down-to=1024&width=1440&height=1126 1024w,https://framerusercontent.com/images/8IMAFAt4WiCjsBlANgyIeXMlaY.png?width=1440&height=1126 1440w",
													},
							...
							<motion4.div
								className={"framer-qebibk"}
								data-framer-name={"audit logs"}
								layoutDependency={layoutDependency}
								layoutId={"MUfAnHi8X"}
							>
								<motion4.div
									className={"framer-nzizf7"}
									data-border={true}
									data-framer-name={"l"}
									layoutDependency={layoutDependency}
									layoutId={"C8YInmAwD"}
								...
								>
									{_jsx4(stdin_default, {
										animated: true,
										className: "framer-1i4g0gd",
										layoutDependency,
										layoutId: "KT9q5tOTs",
									})}
								</motion4.div>
								<motion4.div
									className={"framer-l76an1"}
									data-border={true}
									data-framer-name={"c"}
									layoutDependency={layoutDependency}
									layoutId={"abXkxM2EV"}
								...
								>
									<Image
										background={{
											...
											positionY: "top",
											sizes: `max(max(min(${componentViewport?.width || "100vw"} - 80px, 1360px) - 240px, 1px) / 1.5, 1px)`,
											src: "https://framerusercontent.com/images/ahQnmuMNV0xk6lKBzJueXkJB9k.png?width=1440&height=1126",
											srcSet:
												"https://framerusercontent.com/images/ahQnmuMNV0xk6lKBzJueXkJB9k.png?scale-down-to=512&width=1440&height=1126 512w,https://framerusercontent.com/images/ahQnmuMNV0xk6lKBzJueXkJB9k.png?scale-down-to=1024&width=1440&height=1126 1024w,https://framerusercontent.com/images/ahQnmuMNV0xk6lKBzJueXkJB9k.png?width=1440&height=1126 1440w",
										}}
										className={"framer-113wwll"}
										data-border={true}
										data-framer-name={"img"}
										layoutDependency={layoutDependency}
										layoutId={"Rwxr9Guo8"}
									...
									>
										...
										>
											<SmartComponentScopedContainer
												className={"framer-hm10jn-container"}
												layoutDependency={layoutDependency}
												layoutId={"NGUZl5uDM-container"}
												nodeId={"NGUZl5uDM"}
												rendersWithMotion={true}
												scopeId={"YVrYEME2g"}
											>
												{_jsx4(stdin_default3, {
													...
													kWLkauSoU: "\uE241",
													layoutId: "NGUZl5uDM",
													QpJ3dK1Uw: "safe & complaint",
													width: "100%",
												})}
											</SmartComponentScopedContainer>
										</ComponentViewportProvider>
										<motion4.div
											className={"framer-1l0hs5s"}
											data-framer-name={"text"}
											layoutDependency={layoutDependency}
											layoutId={"UQ3GCTkot"}
										>
														...
														hgCHNxY4q: {
															children: (
																<React4.Fragment>
																	...
																	>
																		{
																			"The final file contains the signed documents and an audit log that tracks who accessed the file and what actions they took. It's cryptographically sealed to ensure tamper-proof, verifiable integrity."
																		}
																	</motion4.p>
																</React4.Fragment>
															),
										...
										>
											<SmartComponentScopedContainer
												className={"framer-1uyt5uf-container"}
												layoutDependency={layoutDependency}
												layoutId={"FFb6c58yp-container"}
												nodeId={"FFb6c58yp"}
												rendersWithMotion={true}
												scopeId={"YVrYEME2g"}
											>
												{_jsx4(stdin_default2, {
													...
													lN8xj7jha: false,
													nY0GKOZdB:
														"https://signatureapi.com/docs/api/resources/deliverables/audit-log",
													ROxksEdqg: "See example",
													variant: "eeLASO7rO",
													width: "100%",
												})}
											</SmartComponentScopedContainer>
							...
							<motion4.div
								className={"framer-1iqqp3j"}
								data-framer-name={"end-empty"}
								layoutDependency={layoutDependency}
								layoutId={"iTwCsJS75"}
							>
								<motion4.div
									className={"framer-1t01w8t"}
									data-framer-name={"l"}
									layoutDependency={layoutDependency}
									layoutId={"LfSI7mqMC"}
								/>
								<motion4.div
									className={"framer-t41u1b"}
									data-border={true}
									data-framer-name={"c"}
									layoutDependency={layoutDependency}
									layoutId={"adzqMstc6"}
							...
							<motion4.div
								className={"framer-17lcyqp"}
								data-framer-name={"tl"}
								layoutDependency={layoutDependency}
								layoutId={"g6bH2x7ev"}
							>
								<motion4.div
									className={"framer-1o0z9i"}
							...
							<motion4.div
								className={"framer-17q3112"}
								data-framer-name={"tr"}
								layoutDependency={layoutDependency}
								layoutId={"Y5ahmPGzK"}
							>
								<motion4.div
									className={"framer-swm44z"}
									data-framer-name={"Rectangle 3"}
									layoutDependency={layoutDependency}
									layoutId={"iQ0lhb9Ba"}
									style={{
							...
							<motion4.div
								className={"framer-qsv4cn"}
								data-framer-name={"bl"}
								layoutDependency={layoutDependency}
								layoutId={"rlQB1kqKC"}
							>
								<motion4.div
									className={"framer-1r6p4cg"}
									data-framer-name={"Rectangle 3"}
									layoutDependency={layoutDependency}
									layoutId={"iqyQxO8Sf"}
									style={{
							...
							<motion4.div
								className={"framer-1uodvqx"}
								data-framer-name={"br"}
								layoutDependency={layoutDependency}
								layoutId={"xn8AmNDTq"}
							>
								<motion4.div
									className={"framer-1psuabk"}
									data-framer-name={"Rectangle 3"}
									layoutDependency={layoutDependency}
									layoutId={"ejYkuUdc7"}
									style={{
...
var css9 = [
	"@supports (aspect-ratio: 1) { body { --framer-aspect-ratio-supported: auto; } }",
	".framer-VnsGL.framer-io9nf8, .framer-VnsGL .framer-io9nf8 { display: block; }",
	".framer-VnsGL.framer-wca900 { align-content: center; align-items: center; display: flex; flex-direction: column; flex-wrap: nowrap; gap: 0px; height: min-content; justify-content: center; overflow: visible; padding: 0px 40px 0px 40px; position: relative; width: 1200px; }",
	".framer-VnsGL .framer-1t8m17v { align-content: flex-start; align-items: flex-start; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 0px; height: min-content; justify-content: center; max-width: 1360px; overflow: hidden; padding: 120px; position: relative; width: 100%; }",
	".framer-VnsGL .framer-1jstzz6 { flex: none; height: auto; position: relative; white-space: pre-wrap; width: 600px; word-break: break-word; word-wrap: break-word; }",
	".framer-VnsGL .framer-1ejo981 { align-content: flex-start; align-items: flex-start; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 0px; height: min-content; justify-content: center; max-width: 1360px; overflow: hidden; padding: 0px; position: relative; width: 100%; }",
	".framer-VnsGL .framer-1hnq8ol, .framer-VnsGL .framer-16pktni, .framer-VnsGL .framer-1iqqp3j { align-content: flex-start; align-items: flex-start; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 0px; height: 24px; justify-content: flex-start; overflow: visible; padding: 0px; position: relative; width: 100%; }",
	".framer-VnsGL .framer-8u1j9i, .framer-VnsGL .framer-1v9dvr8, .framer-VnsGL .framer-1t01w8t, .framer-VnsGL .framer-18hu0ox { align-content: flex-start; align-items: flex-start; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 10px; height: 100%; justify-content: flex-start; min-width: 120px; overflow: hidden; padding: 10px; position: relative; width: min-content; }",
	".framer-VnsGL .framer-vgdj4l, .framer-VnsGL .framer-qctbqw, .framer-VnsGL .framer-t41u1b { align-content: flex-start; align-items: flex-start; display: flex; flex: 1 0 0px; flex-direction: column; flex-wrap: nowrap; gap: 10px; height: 100%; justify-content: flex-start; overflow: hidden; padding: 10px; position: relative; width: 1px; }",
	".framer-VnsGL .framer-1onlhd5, .framer-VnsGL .framer-1bu3a0o { align-content: flex-start; align-items: flex-start; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 10px; height: 100%; justify-content: flex-start; overflow: hidden; padding: 0px; position: relative; width: 16px; }",
	".framer-VnsGL .framer-69zysk, .framer-VnsGL .framer-qebibk { align-content: flex-start; align-items: flex-start; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 0px; height: 560px; justify-content: flex-start; overflow: visible; padding: 0px; position: relative; width: 100%; }",
	".framer-VnsGL .framer-1o0b4lv, .framer-VnsGL .framer-16821jq, .framer-VnsGL .framer-nzizf7, .framer-VnsGL .framer-o79eha { align-content: flex-start; align-items: flex-start; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 10px; height: 100%; justify-content: flex-start; overflow: hidden; padding: 10px; position: relative; width: 120px; }",
	".framer-VnsGL .framer-8q8lf5, .framer-VnsGL .framer-18gjic5, .framer-VnsGL .framer-1i4g0gd, .framer-VnsGL .framer-1iwg8q7 { flex: none; height: var(--framer-aspect-ratio-supported, 816px); left: 0px; position: absolute; top: 0px; width: 1320px; z-index: 1; }",
	".framer-VnsGL .framer-1bnygjp, .framer-VnsGL .framer-l76an1 { align-content: flex-start; align-items: flex-start; display: flex; flex: 1 0 0px; flex-direction: row; flex-wrap: nowrap; gap: 0px; height: 100%; justify-content: flex-start; overflow: hidden; padding: 0px; position: relative; width: 1px; }",
	".framer-VnsGL .framer-pfjwfs { align-content: flex-start; align-items: flex-start; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 48px; height: 100%; justify-content: flex-start; overflow: hidden; padding: 40px 56px 40px 40px; position: relative; width: 33%; }",
	".framer-VnsGL .framer-1936ak5-container, .framer-VnsGL .framer-og9rnu-container, .framer-VnsGL .framer-hm10jn-container, .framer-VnsGL .framer-1uyt5uf-container { flex: none; height: auto; position: relative; width: auto; }",
	".framer-VnsGL .framer-l8s9l5, .framer-VnsGL .framer-1l0hs5s { align-content: flex-start; align-items: flex-start; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 12px; height: min-content; justify-content: flex-start; overflow: visible; padding: 0px; position: relative; width: 100%; }",
	".framer-VnsGL .framer-4gehuu, .framer-VnsGL .framer-ctkrvo, .framer-VnsGL .framer-qdim0n, .framer-VnsGL .framer-d66xxq { flex: none; height: auto; position: relative; white-space: pre-wrap; width: 100%; word-break: break-word; word-wrap: break-word; }",
	".framer-VnsGL .framer-1wbzjoo { align-content: center; align-items: center; display: flex; flex: 1 0 0px; flex-direction: column; flex-wrap: nowrap; height: 100%; justify-content: space-between; overflow: hidden; padding: 0px; position: relative; width: 1px; }",
	".framer-VnsGL .framer-113wwll { align-content: flex-start; align-items: flex-start; display: flex; flex: 1 0 0px; flex-direction: column; flex-wrap: nowrap; height: 100%; justify-content: space-between; overflow: hidden; padding: 0px; position: relative; width: 1px; }",
	".framer-VnsGL .framer-hf1crm { align-content: flex-start; align-items: flex-start; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 48px; height: min-content; justify-content: flex-start; overflow: hidden; padding: 40px 56px 40px 40px; position: relative; width: 33%; }",
	".framer-VnsGL .framer-17lcyqp { flex: none; height: 15px; left: 113px; overflow: visible; position: absolute; top: 17px; width: 15px; z-index: 1; }",
	".framer-VnsGL .framer-1o0z9i, .framer-VnsGL .framer-1szjixn, .framer-VnsGL .framer-swm44z, .framer-VnsGL .framer-2t1hi4, .framer-VnsGL .framer-1r6p4cg, .framer-VnsGL .framer-1r0zlj5, .framer-VnsGL .framer-1psuabk, .framer-VnsGL .framer-1x1fsq7 { flex: none; height: 15px; left: 7px; position: absolute; top: 0px; width: 1px; }",
	".framer-VnsGL .framer-17q3112 { flex: none; height: 15px; overflow: visible; position: absolute; right: 113px; top: 17px; width: 15px; z-index: 1; }",
	".framer-VnsGL .framer-qsv4cn { bottom: 17px; flex: none; height: 15px; left: 113px; overflow: visible; position: absolute; width: 15px; z-index: 1; }",
	".framer-VnsGL .framer-1uodvqx { bottom: 17px; flex: none; height: 15px; overflow: visible; position: absolute; right: 113px; width: 15px; z-index: 1; }",
	".framer-VnsGL.framer-v-e3ermz.framer-wca900 { padding: 0px 20px 0px 20px; width: 800px; }",
	".framer-VnsGL.framer-v-e3ermz .framer-1t8m17v { padding: 80px 120px 40px 56px; }",
	".framer-VnsGL.framer-v-e3ermz .framer-1jstzz6, .framer-VnsGL.framer-v-lggb7y .framer-1jstzz6 { width: 100%; }",
	".framer-VnsGL.framer-v-e3ermz .framer-8u1j9i, .framer-VnsGL.framer-v-e3ermz .framer-1v9dvr8, .framer-VnsGL.framer-v-e3ermz .framer-1t01w8t, .framer-VnsGL.framer-v-e3ermz .framer-18hu0ox { min-width: unset; width: 40px; }",
	".framer-VnsGL.framer-v-e3ermz .framer-69zysk, .framer-VnsGL.framer-v-e3ermz .framer-qebibk { height: 400px; }",
	".framer-VnsGL.framer-v-e3ermz .framer-1o0b4lv, .framer-VnsGL.framer-v-e3ermz .framer-16821jq, .framer-VnsGL.framer-v-e3ermz .framer-nzizf7, .framer-VnsGL.framer-v-e3ermz .framer-o79eha { width: 40px; }",
	".framer-VnsGL.framer-v-e3ermz .framer-8q8lf5, .framer-VnsGL.framer-v-e3ermz .framer-18gjic5, .framer-VnsGL.framer-v-e3ermz .framer-1i4g0gd, .framer-VnsGL.framer-v-e3ermz .framer-1iwg8q7, .framer-VnsGL.framer-v-lggb7y .framer-8q8lf5, .framer-VnsGL.framer-v-lggb7y .framer-18gjic5, .framer-VnsGL.framer-v-lggb7y .framer-1i4g0gd, .framer-VnsGL.framer-v-lggb7y .framer-1iwg8q7 { height: var(--framer-aspect-ratio-supported, 776px); }",
	".framer-VnsGL.framer-v-e3ermz .framer-pfjwfs { gap: 32px; padding: 32px 48px 32px 32px; width: 44%; }",
	".framer-VnsGL.framer-v-e3ermz .framer-hf1crm { gap: 32px; height: 100%; padding: 32px 48px 32px 32px; width: 44%; }",
	".framer-VnsGL.framer-v-e3ermz .framer-17lcyqp, .framer-VnsGL.framer-v-e3ermz .framer-qsv4cn { left: 33px; }",
	".framer-VnsGL.framer-v-e3ermz .framer-1uodvqx { right: 33px; }",
	".framer-VnsGL.framer-v-lggb7y.framer-wca900 { padding: 0px 4px 0px 4px; width: 390px; }",
	".framer-VnsGL.framer-v-lggb7y .framer-1t8m17v { padding: 44px 24px 44px 24px; }",
	".framer-VnsGL.framer-v-lggb7y .framer-1hnq8ol { order: 0; }",
	".framer-VnsGL.framer-v-lggb7y .framer-8u1j9i, .framer-VnsGL.framer-v-lggb7y .framer-1v9dvr8, .framer-VnsGL.framer-v-lggb7y .framer-1t01w8t, .framer-VnsGL.framer-v-lggb7y .framer-18hu0ox { min-width: unset; padding: 0px; width: 16px; }",
	".framer-VnsGL.framer-v-lggb7y .framer-16pktni { order: 2; }",
	".framer-VnsGL.framer-v-lggb7y .framer-69zysk { align-content: center; align-items: center; height: min-content; order: 1; }",
	".framer-VnsGL.framer-v-lggb7y .framer-1o0b4lv, .framer-VnsGL.framer-v-lggb7y .framer-16821jq, .framer-VnsGL.framer-v-lggb7y .framer-nzizf7, .framer-VnsGL.framer-v-lggb7y .framer-o79eha { align-self: stretch; height: auto; padding: 0px; width: 16px; }",
	".framer-VnsGL.framer-v-lggb7y .framer-1bnygjp, .framer-VnsGL.framer-v-lggb7y .framer-l76an1 { flex-direction: column; height: min-content; }",
	".framer-VnsGL.framer-v-lggb7y .framer-pfjwfs { gap: 24px; height: min-content; order: 1; padding: 24px; width: 100%; }",
	".framer-VnsGL.framer-v-lggb7y .framer-1wbzjoo { flex: none; height: 300px; order: 0; width: 100%; }",
	".framer-VnsGL.framer-v-lggb7y .framer-qebibk { align-content: center; align-items: center; height: min-content; order: 3; }",
	".framer-VnsGL.framer-v-lggb7y .framer-113wwll { flex: none; height: 300px; width: 100%; }",
	".framer-VnsGL.framer-v-lggb7y .framer-hf1crm { gap: 24px; padding: 24px; width: 100%; }",
	".framer-VnsGL.framer-v-lggb7y .framer-1iqqp3j { order: 4; }",
	".framer-VnsGL.framer-v-lggb7y .framer-17lcyqp { left: 9px; order: 5; }",
	".framer-VnsGL.framer-v-lggb7y .framer-17q3112 { order: 6; right: 9px; }",
	".framer-VnsGL.framer-v-lggb7y .framer-qsv4cn { left: 9px; order: 7; }",
	".framer-VnsGL.framer-v-lggb7y .framer-1uodvqx { order: 8; right: 9px; }",
	...css,
	...css2,
	...css3,
	'.framer-VnsGL[data-border="true"]::after, .framer-VnsGL [data-border="true"]::after { content: ""; border-width: var(--border-top-width, 0) var(--border-right-width, 0) var(--border-bottom-width, 0) var(--border-left-width, 0); border-color: var(--border-color, none); border-style: var(--border-style, none); width: 100%; height: 100%; position: absolute; box-sizing: border-box; left: 0; top: 0; border-radius: inherit; pointer-events: none; }',
];
var FramerYVrYEME2g = withCSS4(Component4, css9, "framer-VnsGL");
var stdin_default4 = FramerYVrYEME2g;
FramerYVrYEME2g.displayName = "big features";
FramerYVrYEME2g.defaultProps = {
	height: 1504,
	width: 1200,
};
addPropertyControls3(FramerYVrYEME2g, {
	variant: {
		options: ["tndu84moK", "hgCHNxY4q", "c8zs43rnL"],
...
/**
 * Renders BigFeaturesFramerComponent for all breakpoints with a variants map. Variant prop is inferred per breakpoint.
 * @function
...
var big_features_default = ComponentWithRoot;
export { big_features_default as default };
