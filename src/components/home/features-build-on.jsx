...
// /:https://framerusercontent.com/modules/Y5FSptzCimNsZje7fhng/2lfT0jOfZq1X2XUl27wu/oqynJrman.js
...
var cycleOrder2 = ["Sk_Kc0qqD", "TDKl4IL5g", "JqKyPXSAs"];
var serializationHash2 = "framer-qUnFE";
var variantClassNames2 = {
	JqKyPXSAs: "framer-v-zdmuzl",
	Sk_Kc0qqD: "framer-v-x3ogh7",
	TDKl4IL5g: "framer-v-1jw6q4c",
};
...
var getProps3 = ({ height, id, width, ...props }) => {
	return {
		...props,
		variant:
			humanReadableVariantMap2[props.variant] ?? props.variant ?? "Sk_Kc0qqD",
	};
};
				...
				<Transition2 value={transition12}>
					...
					>
						...
						>
								...
								{...addPropertyOverrides2(
									{
										JqKyPXSAs: {
											y:
												...
												0 +
												(((componentViewport?.height || 200) - 0 - 1912) / 2 +
													0 +
													0) +
												44 +
												72,
							...
							>
								<SmartComponentScopedContainer
									className={"framer-19vopho-container"}
									layoutDependency={layoutDependency}
									layoutId={"IMZxiulUk-container"}
									nodeId={"IMZxiulUk"}
								...
								>
									{_jsx3(stdin_default2, {
										...
										layoutId: "IMZxiulUk",
										lN8xj7jha: false,
										nY0GKOZdB: "https://signatureapi.com/changelog",
										ROxksEdqg: "Changelog",
										variant: "eeLASO7rO",
										width: "100%",
									})}
						...
						>
							<motion3.div
								className={"framer-6dslm1"}
								data-framer-name={"start-empty"}
								layoutDependency={layoutDependency}
								layoutId={"Pg_xP4ARL"}
							>
								<motion3.div
									className={"framer-c15xpk"}
									data-framer-name={"l"}
									layoutDependency={layoutDependency}
									layoutId={"BQUH9UCfv"}
								/>
								<motion3.div
									className={"framer-felm0s"}
									data-border={true}
									data-framer-name={"c"}
									layoutDependency={layoutDependency}
									layoutId={"zDsAbXyPL"}
							...
							<motion3.div
								className={"framer-16dg3ai"}
								data-framer-name={"blocks"}
								layoutDependency={layoutDependency}
								layoutId={"V8WFDeScE"}
							>
								<motion3.div
									className={"framer-8h2rzq"}
									data-border={true}
									data-framer-name={"l"}
									layoutDependency={layoutDependency}
									layoutId={"snxEoiU3Q"}
								...
								>
									{_jsx3(stdin_default, {
										animated: true,
										className: "framer-1qemcwj",
										layoutDependency,
										layoutId: "zLuHvxg_F",
									})}
								</motion3.div>
								<motion3.div
									className={"framer-1g8tfrr"}
									data-border={true}
									data-framer-name={"c"}
									layoutDependency={layoutDependency}
									layoutId={"xKWVmTLIR"}
								...
								>
									...
									>
										...
										>
											<RichText2
												__fromCanvasComponent={true}
												className={"framer-lt6mfi"}
												data-framer-name={"sitemap"}
												fonts={["CUSTOM;Font Awesome 6 Pro Light"]}
												layoutDependency={layoutDependency}
												layoutId={"vUDEFrPc8"}
												style={{
													"--extracted-r6o4lv":
															...
															children: (
																<React3.Fragment>
																	<motion3.p
																		style={{
																			"--font-selector":
																				"Q1VTVE9NO0ZvbnQgQXdlc29tZSA2IFBybyBMaWdodA==",
																			"--framer-font-family":
																				'"Font Awesome 6 Pro Light", sans-serif',
										...
										>
											...
											<RichText2
												__fromCanvasComponent={true}
												className={"framer-ayjaw4"}
												data-framer-name={
													"Send to up to 10 signers in a single electronic signature transaction."
												}
												fonts={["Inter"]}
												layoutDependency={layoutDependency}
												layoutId={"o0qyzg1WE"}
									...
									>
										...
										>
											<RichText2
												__fromCanvasComponent={true}
												className={"framer-1ipfmkh"}
												data-framer-name={"code-branch"}
												fonts={["CUSTOM;Font Awesome 6 Pro Light"]}
												layoutDependency={layoutDependency}
												layoutId={"lP0Tb8dva"}
												style={{
									...
									>
										...
										>
											<RichText2
												__fromCanvasComponent={true}
												className={"framer-v2hwhz"}
												data-framer-name={"folder-open"}
												fonts={["CUSTOM;Font Awesome 6 Pro Light"]}
												layoutDependency={layoutDependency}
												layoutId={"ERJnzUQyY"}
												style={{
									...
									>
										...
										>
											<RichText2
												__fromCanvasComponent={true}
												className={"framer-4lnthm"}
												data-framer-name={"Languages & Localization"}
												fonts={["Inter"]}
												layoutDependency={layoutDependency}
												layoutId={"kAMtcTl4C"}
												style={{
											...
											<RichText2
												__fromCanvasComponent={true}
												className={"framer-1pqxu0i"}
												data-framer-name={
													"Customize\xA0languages, date-time formats, and time zones in the signing interface."
												}
												fonts={["Inter"]}
												layoutDependency={layoutDependency}
												layoutId={"o5oS2MYTx"}
															...
															children: (
																<React3.Fragment>
																	...
																	>
																		...
																		<Link2
																			href={
																				"https://signatureapi.com/docs/api/resources/envelopes/language"
																			}
																			motionChild={true}
																			nodeId={"o5oS2MYTx"}
																			openInNewTab={false}
																			...
																			smoothScroll={false}
																		>
																			<motion3.a>{"languages"}</motion3.a>
																		</Link2>
																		{
																			", date-time formats, and time zones in the signing interface."
																		}
																	</motion3.p>
																</React3.Fragment>
															),
									...
									>
										...
										>
											<RichText2
												__fromCanvasComponent={true}
												className={"framer-91py9e"}
												data-framer-name={"face-smile"}
												fonts={["CUSTOM;Font Awesome 6 Pro Light"]}
												layoutDependency={layoutDependency}
												layoutId={"ZucatRGxh"}
												style={{
										...
										>
											<RichText2
												__fromCanvasComponent={true}
												className={"framer-1e5qbp7"}
												data-framer-name={"Accountless Signing"}
												fonts={["Inter"]}
												layoutDependency={layoutDependency}
												layoutId={"HFaFUPpOR"}
												style={{
											...
											<RichText2
												__fromCanvasComponent={true}
												className={"framer-14c9rlz"}
												data-framer-name={
													"Recipients can sign documents without needing to create or log into an account."
												}
												fonts={["Inter"]}
												layoutDependency={layoutDependency}
												layoutId={"oLQDmLyGG"}
									...
									>
										...
										>
											<RichText2
												__fromCanvasComponent={true}
												className={"framer-1xlv6l1"}
												data-framer-name={"comment-check"}
												fonts={["CUSTOM;Font Awesome 6 Pro Light"]}
												layoutDependency={layoutDependency}
												layoutId={"shwGPpVu6"}
												style={{
										...
										>
											<RichText2
												__fromCanvasComponent={true}
												className={"framer-u5u24b"}
												data-framer-name={"Real-Time Notifications"}
												fonts={["Inter"]}
												layoutDependency={layoutDependency}
												layoutId={"ER4dkW7BZ"}
												style={{
											...
											<RichText2
												__fromCanvasComponent={true}
												className={"framer-hz37mn"}
												data-framer-name={
													"Receive immediate updates on signing activities via emails and webhooks."
												}
												fonts={["Inter"]}
												layoutDependency={layoutDependency}
												layoutId={"f7GXwFEW5"}
							...
							<motion3.div
								className={"framer-2mxjdh"}
								data-framer-name={"end-empty"}
								layoutDependency={layoutDependency}
								layoutId={"ZB9puCfO7"}
							>
								<motion3.div
									className={"framer-15z5drh"}
									data-framer-name={"l"}
									layoutDependency={layoutDependency}
									layoutId={"aqfqtujU_"}
								/>
								<motion3.div
									className={"framer-lxzgow"}
									data-border={true}
									data-framer-name={"c"}
									layoutDependency={layoutDependency}
									layoutId={"BnJcJaU7C"}
							...
							<motion3.div
								className={"framer-5axnym"}
								data-framer-name={"tl"}
								layoutDependency={layoutDependency}
								layoutId={"Db7KlQZdT"}
							>
								<motion3.div
									className={"framer-1aqc2ln"}
							...
							<motion3.div
								className={"framer-v9o2vo"}
								data-framer-name={"tr"}
								layoutDependency={layoutDependency}
								layoutId={"Gm_Jdk8O8"}
							>
								<motion3.div
									className={"framer-16iv3j0"}
									data-framer-name={"Rectangle 3"}
									layoutDependency={layoutDependency}
									layoutId={"QwzPJIr7J"}
									style={{
							...
							<motion3.div
								className={"framer-1go587n"}
								data-framer-name={"bl"}
								layoutDependency={layoutDependency}
								layoutId={"rhgmLuTij"}
							>
								<motion3.div
									className={"framer-6fhcg0"}
									data-framer-name={"Rectangle 3"}
									layoutDependency={layoutDependency}
									layoutId={"Wk7OYBBIV"}
									style={{
							...
							<motion3.div
								className={"framer-glexo3"}
								data-framer-name={"br"}
								layoutDependency={layoutDependency}
								layoutId={"VKn91EVHZ"}
							>
								<motion3.div
									className={"framer-13gf6gd"}
									data-framer-name={"Rectangle 3"}
									layoutDependency={layoutDependency}
									layoutId={"cWGQuLXPH"}
									style={{
...
var css8 = [
	"@supports (aspect-ratio: 1) { body { --framer-aspect-ratio-supported: auto; } }",
	".framer-qUnFE.framer-l9sakv, .framer-qUnFE .framer-l9sakv { display: block; }",
	".framer-qUnFE.framer-x3ogh7 { align-content: center; align-items: center; display: flex; flex-direction: column; flex-wrap: nowrap; gap: 0px; height: min-content; justify-content: center; overflow: visible; padding: 0px 40px 0px 40px; position: relative; width: 1200px; }",
	".framer-qUnFE .framer-ao8x3y { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; height: min-content; justify-content: space-between; max-width: 1360px; overflow: visible; padding: 120px 120px 40px 120px; position: relative; width: 100%; }",
	".framer-qUnFE .framer-1o6qugj { flex: 1 0 0px; height: auto; position: relative; white-space: pre-wrap; width: 1px; word-break: break-word; word-wrap: break-word; }",
	".framer-qUnFE .framer-19vopho-container { flex: none; height: auto; position: relative; width: auto; }",
	".framer-qUnFE .framer-1c4buot { align-content: flex-start; align-items: flex-start; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 0px; height: min-content; justify-content: center; max-width: 1360px; overflow: hidden; padding: 0px; position: relative; width: 100%; }",
	".framer-qUnFE .framer-6dslm1, .framer-qUnFE .framer-2mxjdh { align-content: flex-start; align-items: flex-start; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 0px; height: 24px; justify-content: flex-start; overflow: visible; padding: 0px; position: relative; width: 100%; }",
	".framer-qUnFE .framer-c15xpk, .framer-qUnFE .framer-1ff0uvm, .framer-qUnFE .framer-15z5drh, .framer-qUnFE .framer-ir4lob { align-content: flex-start; align-items: flex-start; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 10px; height: 100%; justify-content: flex-start; min-width: 120px; overflow: hidden; padding: 10px; position: relative; width: min-content; }",
	".framer-qUnFE .framer-felm0s, .framer-qUnFE .framer-lxzgow { align-content: flex-start; align-items: flex-start; display: flex; flex: 1 0 0px; flex-direction: column; flex-wrap: nowrap; gap: 10px; height: 100%; justify-content: flex-start; overflow: hidden; padding: 10px; position: relative; width: 1px; }",
	".framer-qUnFE .framer-16dg3ai { align-content: flex-start; align-items: flex-start; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 0px; height: min-content; justify-content: flex-start; overflow: visible; padding: 0px; position: relative; width: 100%; }",
	".framer-qUnFE .framer-8h2rzq, .framer-qUnFE .framer-uyakjw { align-content: flex-start; align-items: flex-start; align-self: stretch; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 10px; height: auto; justify-content: flex-start; overflow: hidden; padding: 10px; position: relative; width: 120px; }",
	".framer-qUnFE .framer-1qemcwj, .framer-qUnFE .framer-1s2t8wp { flex: none; height: var(--framer-aspect-ratio-supported, 815px); left: 0px; position: absolute; top: 0px; width: 1320px; z-index: 1; }",
	".framer-qUnFE .framer-1g8tfrr { align-content: flex-start; align-items: flex-start; display: flex; flex: 1 0 0px; flex-direction: row; flex-wrap: wrap; gap: 0px; height: min-content; justify-content: flex-start; overflow: hidden; padding: 0px; position: relative; width: 1px; }",
	".framer-qUnFE .framer-7koge3, .framer-qUnFE .framer-k9bzwr, .framer-qUnFE .framer-li9kuu, .framer-qUnFE .framer-353o6j { align-content: flex-start; align-items: flex-start; align-self: stretch; display: flex; flex: 1 0 0px; flex-direction: column; flex-wrap: nowrap; gap: 48px; height: auto; justify-content: flex-start; min-width: 281px; overflow: hidden; padding: 40px 48px 40px 40px; position: relative; width: 1px; }",
	".framer-qUnFE .framer-73ekcn, .framer-qUnFE .framer-1lwsn0p, .framer-qUnFE .framer-dr9ihh, .framer-qUnFE .framer-cunnnc, .framer-qUnFE .framer-vpfgnr, .framer-qUnFE .framer-fqi4uf { align-content: center; align-items: center; aspect-ratio: 1 / 1; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 0px; height: var(--framer-aspect-ratio-supported, 48px); justify-content: center; overflow: hidden; padding: 0px; position: relative; width: 48px; will-change: var(--framer-will-change-override, transform); }",
	".framer-qUnFE .framer-lt6mfi, .framer-qUnFE .framer-1ipfmkh, .framer-qUnFE .framer-v2hwhz, .framer-qUnFE .framer-u1sp1y, .framer-qUnFE .framer-91py9e, .framer-qUnFE .framer-1xlv6l1 { flex: none; height: auto; position: relative; white-space: pre; width: auto; }",
	".framer-qUnFE .framer-1x3o41p, .framer-qUnFE .framer-1ld64b2, .framer-qUnFE .framer-p1bmn4, .framer-qUnFE .framer-1fxxl55, .framer-qUnFE .framer-1mhgdke, .framer-qUnFE .framer-6qa5lg { align-content: flex-start; align-items: flex-start; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 12px; height: min-content; justify-content: flex-start; overflow: visible; padding: 0px; position: relative; width: 100%; }",
	".framer-qUnFE .framer-vdzo2j, .framer-qUnFE .framer-ayjaw4, .framer-qUnFE .framer-3jk3um, .framer-qUnFE .framer-17lxpnk, .framer-qUnFE .framer-1crdnqw, .framer-qUnFE .framer-vjzbdl, .framer-qUnFE .framer-4lnthm, .framer-qUnFE .framer-1pqxu0i, .framer-qUnFE .framer-1e5qbp7, .framer-qUnFE .framer-14c9rlz, .framer-qUnFE .framer-u5u24b, .framer-qUnFE .framer-hz37mn { flex: none; height: auto; position: relative; white-space: pre-wrap; width: 100%; word-break: break-word; word-wrap: break-word; }",
	".framer-qUnFE .framer-9kqea6, .framer-qUnFE .framer-18mhwrm { align-content: flex-start; align-items: flex-start; display: flex; flex: 1 0 0px; flex-direction: column; flex-wrap: nowrap; gap: 48px; height: min-content; justify-content: flex-start; min-width: 281px; overflow: hidden; padding: 40px 48px 40px 40px; position: relative; width: 1px; }",
	".framer-qUnFE .framer-5axnym { flex: none; height: 15px; left: 113px; overflow: visible; position: absolute; top: 17px; width: 15px; z-index: 1; }",
	".framer-qUnFE .framer-1aqc2ln, .framer-qUnFE .framer-9crx4g, .framer-qUnFE .framer-16iv3j0, .framer-qUnFE .framer-1hq6qo0, .framer-qUnFE .framer-6fhcg0, .framer-qUnFE .framer-s29sh0, .framer-qUnFE .framer-13gf6gd, .framer-qUnFE .framer-wi2va0 { flex: none; height: 15px; left: 7px; position: absolute; top: 0px; width: 1px; }",
	".framer-qUnFE .framer-v9o2vo { flex: none; height: 15px; overflow: visible; position: absolute; right: 113px; top: 17px; width: 15px; z-index: 1; }",
	".framer-qUnFE .framer-1go587n { bottom: 17px; flex: none; height: 15px; left: 113px; overflow: visible; position: absolute; width: 15px; z-index: 1; }",
	".framer-qUnFE .framer-glexo3 { bottom: 17px; flex: none; height: 15px; overflow: visible; position: absolute; right: 113px; width: 15px; z-index: 1; }",
	".framer-qUnFE.framer-v-1jw6q4c.framer-x3ogh7 { padding: 0px 20px 0px 20px; width: 800px; }",
	".framer-qUnFE.framer-v-1jw6q4c .framer-ao8x3y { padding: 80px 56px 40px 56px; }",
	".framer-qUnFE.framer-v-1jw6q4c .framer-c15xpk, .framer-qUnFE.framer-v-1jw6q4c .framer-1ff0uvm, .framer-qUnFE.framer-v-1jw6q4c .framer-15z5drh, .framer-qUnFE.framer-v-1jw6q4c .framer-ir4lob { min-width: unset; width: 40px; }",
	".framer-qUnFE.framer-v-1jw6q4c .framer-8h2rzq, .framer-qUnFE.framer-v-1jw6q4c .framer-uyakjw, .framer-qUnFE.framer-v-zdmuzl .framer-73ekcn, .framer-qUnFE.framer-v-zdmuzl .framer-1lwsn0p, .framer-qUnFE.framer-v-zdmuzl .framer-dr9ihh, .framer-qUnFE.framer-v-zdmuzl .framer-cunnnc, .framer-qUnFE.framer-v-zdmuzl .framer-vpfgnr, .framer-qUnFE.framer-v-zdmuzl .framer-fqi4uf { width: 40px; }",
	".framer-qUnFE.framer-v-1jw6q4c .framer-1qemcwj, .framer-qUnFE.framer-v-1jw6q4c .framer-1s2t8wp, .framer-qUnFE.framer-v-zdmuzl .framer-1qemcwj, .framer-qUnFE.framer-v-zdmuzl .framer-1s2t8wp { height: var(--framer-aspect-ratio-supported, 776px); }",
	".framer-qUnFE.framer-v-1jw6q4c .framer-7koge3, .framer-qUnFE.framer-v-1jw6q4c .framer-9kqea6, .framer-qUnFE.framer-v-1jw6q4c .framer-k9bzwr, .framer-qUnFE.framer-v-1jw6q4c .framer-18mhwrm, .framer-qUnFE.framer-v-1jw6q4c .framer-li9kuu, .framer-qUnFE.framer-v-1jw6q4c .framer-353o6j { gap: 32px; min-width: 280px; padding: 32px 40px 32px 32px; }",
	".framer-qUnFE.framer-v-1jw6q4c .framer-73ekcn, .framer-qUnFE.framer-v-1jw6q4c .framer-1lwsn0p, .framer-qUnFE.framer-v-1jw6q4c .framer-dr9ihh, .framer-qUnFE.framer-v-1jw6q4c .framer-cunnnc, .framer-qUnFE.framer-v-1jw6q4c .framer-vpfgnr, .framer-qUnFE.framer-v-1jw6q4c .framer-fqi4uf { height: var(--framer-aspect-ratio-supported, 39px); width: 40px; }",
	".framer-qUnFE.framer-v-1jw6q4c .framer-5axnym, .framer-qUnFE.framer-v-1jw6q4c .framer-1go587n { left: 33px; }",
	".framer-qUnFE.framer-v-1jw6q4c .framer-v9o2vo, .framer-qUnFE.framer-v-1jw6q4c .framer-glexo3 { right: 33px; }",
	".framer-qUnFE.framer-v-zdmuzl.framer-x3ogh7 { padding: 0px 4px 0px 4px; width: 390px; }",
	".framer-qUnFE.framer-v-zdmuzl .framer-ao8x3y { align-content: flex-start; align-items: flex-start; flex-direction: column; gap: 24px; justify-content: flex-start; padding: 44px 24px 32px 24px; }",
	".framer-qUnFE.framer-v-zdmuzl .framer-1o6qugj { flex: none; width: 100%; }",
	".framer-qUnFE.framer-v-zdmuzl .framer-c15xpk, .framer-qUnFE.framer-v-zdmuzl .framer-1ff0uvm, .framer-qUnFE.framer-v-zdmuzl .framer-15z5drh, .framer-qUnFE.framer-v-zdmuzl .framer-ir4lob { min-width: unset; padding: 0px; width: 16px; }",
	".framer-qUnFE.framer-v-zdmuzl .framer-8h2rzq, .framer-qUnFE.framer-v-zdmuzl .framer-uyakjw { padding: 0px; width: 16px; }",
	".framer-qUnFE.framer-v-zdmuzl .framer-1g8tfrr { flex-direction: column; }",
	".framer-qUnFE.framer-v-zdmuzl .framer-7koge3, .framer-qUnFE.framer-v-zdmuzl .framer-k9bzwr, .framer-qUnFE.framer-v-zdmuzl .framer-li9kuu, .framer-qUnFE.framer-v-zdmuzl .framer-353o6j { align-self: unset; flex: none; gap: 24px; height: min-content; min-width: unset; padding: 24px 40px 24px 24px; width: 100%; }",
	".framer-qUnFE.framer-v-zdmuzl .framer-9kqea6, .framer-qUnFE.framer-v-zdmuzl .framer-18mhwrm { flex: none; gap: 24px; min-width: unset; padding: 24px 40px 24px 24px; width: 100%; }",
	".framer-qUnFE.framer-v-zdmuzl .framer-5axnym, .framer-qUnFE.framer-v-zdmuzl .framer-1go587n { left: 9px; }",
	".framer-qUnFE.framer-v-zdmuzl .framer-v9o2vo, .framer-qUnFE.framer-v-zdmuzl .framer-glexo3 { right: 9px; }",
	...css4,
	...css3,
	...css,
	...css2,
	'.framer-qUnFE[data-border="true"]::after, .framer-qUnFE [data-border="true"]::after { content: ""; border-width: var(--border-top-width, 0) var(--border-right-width, 0) var(--border-bottom-width, 0) var(--border-left-width, 0); border-color: var(--border-color, none); border-style: var(--border-style, none); width: 100%; height: 100%; position: absolute; box-sizing: border-box; left: 0; top: 0; border-radius: inherit; pointer-events: none; }',
];
var FrameroqynJrman = withCSS3(Component3, css8, "framer-qUnFE");
var stdin_default3 = FrameroqynJrman;
FrameroqynJrman.displayName = "features-build-on";
FrameroqynJrman.defaultProps = {
	height: 912,
	width: 1200,
};
addPropertyControls2(FrameroqynJrman, {
	variant: {
		options: ["Sk_Kc0qqD", "TDKl4IL5g", "JqKyPXSAs"],
	...
	[
		{
			...
			fonts: [
				...
				{
					family: "Font Awesome 6 Pro Light",
					source: "custom",
					url: "https://framerusercontent.com/assets/VMJQKQpeiwXUT1r3ORZa7BMy3GA.woff2",
				},
			],
		},
		...ButtonOutlineFonts,
...
/**
 * Renders FeaturesBuildOnFramerComponent for all breakpoints with a variants map. Variant prop is inferred per breakpoint.
 * @function
...
var features_build_on_default = ComponentWithRoot;
export { features_build_on_default as default };
